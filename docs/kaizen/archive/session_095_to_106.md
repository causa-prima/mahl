...
- **[MITTEL] [PROZESS] [Skill-Nutzung] LL-S106-1 – Lösungskandidat bei OBS-Erfassung ankert den Drain-Agenten**
  Quelle: User
...
- **[HOCH] [QUALITÄT] [TS-Code] LL-S101-1 – Negativ-Assertions sind vakuös-anfällig, brauchen einen Faithfulness-Beweis**
  Quelle: Orchestrator
...
- **[HOCH] [TOOLING] [Mutation-Testing] LL-S100-1 – Parallele/gekillte Stryker-Läufe korrumpieren die geteilte `.stryker-tmp`-Sandbox**
  Quelle: Orchestrator
...
- **[HOCH] [PROZESS] [Doku] LL-S099-2 – Mechanismus nur über seinen Fehler dokumentiert → Ersatz droht valide Zweitfunktion zu verlieren**
  Quelle: User
...
- **[MITTEL] [TOOLING] [Testing] LL-S098-1 – Prozess-Env für gespawnte Tools kann still überschrieben werden**
  Quelle: User
...
- **[HOCH] [AGENT] [Review] LL-S096-1 – Reviewer-/eigene Behauptungen ungeprüft weitergereicht**
  Quelle: User
