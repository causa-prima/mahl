...
- **[HOCH] [PROZESS] [Testing] LL-S131-1 – Fixture mit einem Eintrag prueft einen Fall, den es real nie gibt**
  Quelle: Orchestrator
...
- **[HOCH] [PROZESS] [Doku] LL-S132-2 – Gescheiterter Versuch als „nicht erneut probieren" erfasst, ohne Ursache: richtiger Weg blieb 40 Sessions gesperrt**
  Quelle: Orchestrator
