...
- **[HOCH] [PROZESS] [Doku] LL-S118-1 – Eine Fehlablage erbt die Wiedervorlage ihres Zielorts, nicht die ihres Inhalts**
  Quelle: User
...
- **[HOCH] [QUALITÄT] [Review] LL-S120-4 – Gegenprobe vorgeschlagen, die die beiden Varianten mathematisch gar nicht unterscheiden kann**
  Quelle: Subagent
...
- **[HOCH] [TOOLING] [Hook/Script] LL-S121-1 – Tracker-Schreibscript zerstoerte einen Eintrag strukturell; Schaden fiel erst zehn Sessions spaeter auf**
  Quelle: Orchestrator
...
- **[HOCH] [PROZESS] [Kommunikation] LL-S121-2 – Gemessen wurde, wofuer Daten dalagen - nicht, was die Frage beantwortet**
  Quelle: User
