...
- **[HOCH] [TOOLING] [Mutation-Testing] Mutation-Gate war dekorativ – nirgends mechanisch erzwungen**
...
- **[MITTEL] [TOOLING] [Mutation-Testing] Eigene Metrik statt der Tool-eigenen nachgerechnet**
...
- **[MITTEL] [PROZESS] [Sonstiges] Abschluss-Artefakte von Hand statt via closing-session**
...
- **[HOCH] [PROZESS] [Hook/Script] Datei-Rename brach einen funktionalen Pfad-Matcher, nicht nur Links**
...
- **[MITTEL] [PROZESS] [Hook/Script] Referenz-Migration muss alle Verweis-Formen abdecken**
...
- **[MITTEL] [TOOLING] [Hook/Script] docs/reference/dependencies.md-Hook blockiert auch reine Refactoring-Edits**
...
- **[MITTEL] [TOOLING] [Mutation-Testing] JSON vor SHA-256 normalisieren**
...
- **[MITTEL] [TOOLING] [Agent-Prompt] Custom-Subagent in derselben Session nicht nutzbar**
...
- **[GERING] [QUALITÄT] [Mutation-Testing] Attestierungs-Hash über Rohdaten, nicht abgeleitete Werte**
