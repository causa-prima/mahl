...
- **[HOCH] [AGENT] [Kommunikation] LL-S123-3 – grep -c zaehlt Vorkommen, nicht Objekte - Zahl als Statusbefund vorgelegt**
  Quelle: Orchestrator
...
- **[HOCH] [AGENT] [Kommunikation] LL-S124-3 – Fehlalarmquote auf dem bereits bereinigten Bestand gerechnet**
  Quelle: User
...
- **[HOCH] [TOOLING] [Bash/Permission] LL-S125-4 – Backticks im Bash-Argument zerstoerten den geschriebenen Tracker-Eintrag**
  Quelle: Orchestrator
