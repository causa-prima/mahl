...
- **Reviewer-Agenten nie mit Iterations-Vorwissen befragen.**
  Jeder Review-Agent erhält keinen Kontext über frühere Review-Runden. Vorwissen dämpft die
...
- **Guidelines aktiv auf den konkreten Fall anwenden, nicht nur lesen.**
