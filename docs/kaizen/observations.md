...
## OBS-S124-1 – Prioritaeten mit Faellig jetzt verlieren den Aufgaben-Slot dauerhaft an den OBS-Drain
- Quelle: User
- Status: NEU
- Impact: MITTEL    Häufigkeit: dauerhaft
- Kategorie: TOOLING    Kontext: Hook/Script
- Beobachtung: session-agenda.py waehlt die "Naechste Aufgabe" nach fester Rangfolge: retro > obs-drain > priorities > next-run. Ein Prioritaeten-Punkt mit Faellig jetzt beansprucht den Slot also nur, wenn weder eine Retro faellig ist noch ein Drain-Satz vorliegt - und ein Drain-Satz liegt praktisch immer vor, weil das Backlog laufend nachwaechst. Folge am Bestand: OBS-S112-7 steht seit S115 als Faellig jetzt in AGENT_MEMORY und wurde neun Sessions lang nicht als Aufgabe vorgelegt; sichtbar war es nur als Stub-Zeile ("Prioritaeten: 9 offen, davon 5x Faellig jetzt"). Damit sagt der Anker etwas anderes, als der Mechanismus tut: jetzt bedeutet laut AGENT_MEMORY-Header "vor dem Beginn der naechsten Story", faktisch bedeutet es "irgendwann nach dem Drain". Das entwertet den Anker auch fuer die uebrigen Punkte, die ihn tragen - derzeit fuenf von neun. Die Abwaegung ist offen und hat zwei Seiten: Der Drain hat den Vorrang aus gutem Grund, weil nur er ratenbegrenzt ist und sein Backlog sonst monoton waechst, waehrend Prioritaeten nicht verfallen. Umgekehrt geht ein Vorrang fuer jetzt-Punkte am Drain-Score vorbei, der eigens gebaut wurde, um die Reihenfolge innerhalb des Drains zu steuern. Zu klaeren ist daher nicht nur, ob jetzt-Punkte den Slot bekommen sollen, sondern woran ihre Dringlichkeit gegen einen Drain-Satz ueberhaupt vergleichbar gemacht wird.
- Vorprägung: User in S124: "Das jetzt nicht jetzt sofort vor allem anderen bedeutet, liegt am Drain-Script und/oder dem Startup-Injektor. Prinzipiell ist es vermutlich nicht falsch, aber ggfs. ist hier noch eine Behandlungsluecke, wenn im Startup Eintraege mit JETZT nicht auftauchen sollten - das wuerde aber auch am Drain-Score vorbeigehen und sollte also abgewogen werden." Orchestrator-Vermutung, ungeprueft: Eine Alters-Regel analog zur Alters-Lane des Drains koennte den Slot erzwingen, sobald ein jetzt-Punkt N Sessions unbearbeitet liegt.
- Zusammen-erledigen: keiner
- Entscheidung/Maßnahme: offen - beim Drain Kandidaten erstellen und bewerten
