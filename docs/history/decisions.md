...
| Einkaufslisten-Feature implementieren | [Einkaufsliste UX: Bring!](#einkaufsliste-ux-referenz-bring), [Offline-Sync](#offline-sync-strategie-us-306),
[Service-Layer](#service-layer--custom-hooks--match-pflicht) |
| Ingredient-Feature (Frontend+Backend) | [Ingredients-Endpoints](#ingredients-endpoints), [Service-Layer](#service-layer--custom-hooks--match-pflicht),
[ETag](#http-caching--optimistic-concurrency) |
| Jede neue Entity anlegen | [UUIDv7](#uuidv7-für-alle-primärschlüssel-serverside-generiert),
[Soft-Delete](#soft-delete-deletedat-timestamptz-statt-isdeleted-bool), [ETag-Policy](#globale-etag-policy-alle-mutierbaren-ressourcen) |
...
### POST /api/ingredients – 201-Response-Body und Location-Header
...
### GET /api/ingredients – soft-delete filter: Stryker-Suppression
...
### POST /api/ingredients – Validierungs-Fehlermeldungsstrings: Stryker-Suppression
...
### TestWebApplicationFactory: InMemoryDatabaseRoot für DB-Sichtbarkeit über Context-Grenzen
