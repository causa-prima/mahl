...
// der deutsche Text entstehen je Verwendungsstelle an der API-Grenze (ADR-S051-2; Meldungen an die Grenze).
...
// Domänentyp (docs/guidelines/coding-guideline-csharp.md#CGC-regel-rolle-typ):
// die Einheit einer Zutat
