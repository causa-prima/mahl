...
from prozesscode import _session_logs as sl
...
def test_built_artifacts_win_over_the_archive_marker():
    ...
    paths = {"prozesscode/obs-drain.py", "docs/kaizen/archive/observations_archive.md"}
...
def test_falls_back_to_heuristic_without_any_skill():
    art, herkunft = sl.session_type("abc", Counter(), {}, {"prozesscode/foo.py"})
