...
Entitäten und ihre Zustände: [aus dem Kontext-Laden]
...
„Sichtbares Feedback"/„Sperren während Pending"): (a) der auslösende Button ist deaktiviert; (b) JEDE
...
1. ZUSTANDS-MATRIX: Für jede betroffene Entität:
   ...
   **Zweiphasen-Regel:**
   - In der Analyse-Matrix: technische Kürzel erlaubt, z.B. „400 – Name leer"
   - Im Gherkin-Output: ausschließlich fachliche Sprache im Then – übersetze explizit
