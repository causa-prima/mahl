...
2. Findings im **Haupt-Thread** auswerten:
   ...
   **beobachtbares Nutzerverhalten** (neue Reaktion auf eine Eingabe, geändertes Timing, ein
   ...
   Szenario ihn deckt. Grund: Der Blob-Anker aus Schritt 3 sichert nur Test-Änderungen **nach**
   ...
   Fix ins Feature-File (Ablage-Regel: `gherkin-workshop` Schritt 1); ist das zu groß für diesen
