...
Aufruf: `python3 .claude/scripts/commit_msg.py <nachrichtendatei>` – exit 1 blockiert den Commit.
...
from repo_kontext import TRAILER_RE, current_session, repo_root  # noqa: E402
