...
Verwendung:
  python3 .claude/scripts/ruff-run.py            # Verdikt, im Fehlerfall die Fundstellen
  python3 .claude/scripts/ruff-run.py --verbose  # vollständiger Output
...
# Wrapper unter `scripts/` genauso Fehler tragen können wie die Hooks selbst.
PFADE = (".claude/scripts", ".claude/hooks")
