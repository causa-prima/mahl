...
Beispiele:
  python3 .claude/scripts/oq.py list
  python3 .claude/scripts/oq.py get OQ-S094-1
  python3 .claude/scripts/oq.py add --titel "…" --frage "…" \\
      --faellig "Phase:V1 – warum jetzt noch nicht" --hintergrund "…"
  python3 .claude/scripts/oq.py set OQ-S094-1 --faellig "S140 – verschoben, weil …"
  python3 .claude/scripts/oq.py remove OQ-S094-1
