...
MUSTER_AUSNAHMEN: dict[str, frozenset[str]] = {
    ".claude/hooks/tests/test_anchors.py": frozenset({"verweis", "ordinal"}),
    ".claude/hooks/tests/test_check_anchors.py": frozenset({"verweis", "ordinal"}),
    ".claude/hooks/tests/test_ordinale.py": frozenset({"verweis", "ordinal"}),
    ".claude/hooks/tests/test_check_ordinale.py": frozenset({"verweis", "ordinal"}),
}
...
def _ziel_datei(quelle: str, pfad: str) -> str:
    ...
    if not quelle.endswith(".md"):
        ...
        # `.claude/hooks/checks/` ein falscher Pfad.
