...
Beispiele:
  python3 .claude/scripts/td.py list
  python3 .claude/scripts/td.py get TD-S089-1
  python3 .claude/scripts/td.py add --titel "…" --faellig "jetzt – warum sofort" \\
      --problem "…" --behebung "…" --done "woran man das Erledigtsein erkennt"
  python3 .claude/scripts/td.py set TD-S089-1 --faellig "Phase:MVP – verschoben, weil …"
  python3 .claude/scripts/td.py remove TD-S089-1
...
import td_entry as tde  # noqa: E402
