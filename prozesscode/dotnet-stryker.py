...
Verwendung:
  ...
  python3 -m prozesscode.dotnet-stryker --mutate Domain/Foo.cs
  python3 -m prozesscode.dotnet-stryker --mutate Domain/Foo.cs,Endpoints/Bar.cs
...
_TMP_FILE     = _REPO_ROOT / ".claude" / "tmp" / "stryker_out.txt"
...
def main() -> None:
    ...
    summary_args = [sys.executable, "-m", "prozesscode.stryker-summary"]
    if args.verbose:
