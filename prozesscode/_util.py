"""Shared helpers für den Prozess-Code: native dotnet/npm-Aufrufe (WSL-native Toolchain)."""
import os
import subprocess
...
REPO_ROOT: Path = Path(
    os.environ.get("CLAUDE_PROJECT_DIR", str(Path(__file__).resolve().parents[1]))
)
