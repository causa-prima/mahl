...
Das spiegelt ein bereits vorhandenes Muster: `prozesscode/decisions.py check` prüft
...
_SKIP_DIRS = {
    ...
    # Repo-Kopie, die mutmut für den Mutationslauf anlegt. Ohne sie ließe sich nach einem
    # Lauf kein erledigter Eintrag mehr löschen – jeder Verweis stünde ein zweites Mal da.
    "mutants",
}
_SKIP_PREFIXES = (
