...
Verwendung:
  python3 -m prozesscode.coverage-run            # Gesamtwert + die schwächsten Module
  python3 -m prozesscode.coverage-run --verbose  # vollständige Tabelle
