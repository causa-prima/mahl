...
AREA_PREFIXES = (
    ...
    # Der frühere Ort desselben Codes. Logs vor dem Umzug (S129) nennen ihn – ohne diese
    # Zeile fiele die halbe Historie in „.claude/ (sonstige)" und der Bereichsvergleich
    # über die Zeit wäre still falsch.
    (".claude/scripts", "prozesscode"),
    (".claude/hooks", "prozesscode"),
