...
Verwendung:
  python3 -m prozesscode.stryker-summary                          # neuester Report
  python3 -m prozesscode.stryker-summary path/to/report.json
  python3 -m prozesscode.stryker-summary --verbose                # alle nicht-getöteten Mutanten
...
def find_latest_report(base_dir: str = "StrykerOutput/Backend") -> Path:
    output_dir = Path(__file__).parent.parent / base_dir
